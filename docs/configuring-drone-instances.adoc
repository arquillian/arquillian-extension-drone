...
`java -Dwebdriver.gecko.driver=target/.../geckodriver -jar target/.../selenium-server-standalone-3.7.0.jar -port 4444`
...
`java -Dwebdriver.gecko.driver=target/.../geckodriver -jar target/.../selenium-server-standalone-3.7.0.jar -port 4444 -debug true -role node -browserTimeout 1000`
