...
/**
 * Defines a contract for instantiating a Web Test Driver
 * 
 * @param <T> Type of Web Test instances
 * @param <C> Type of Web Test configurations
...
{
   /**
    * Creates an instance of Web Test Driver.
    * 
