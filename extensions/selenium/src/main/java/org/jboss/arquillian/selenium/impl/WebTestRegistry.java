...
public class WebTestRegistry
{
    ...
    */
   public WebTestRegistry registerConfiguratorFor(Class<?> key, Configurator<?, ?> configurator)
   {
    ...
    * @return Modified registry
    */
   public WebTestRegistry registerInstantiatorFor(Class<?> key, Instantiator<?, ?> value)
   {
      RegistryValue entry = registry.get(key);
      if (entry != null)
      {
    ...
    * @return Modified registry
    */
   public WebTestRegistry registerDestructorFor(Class<?> key, Destructor<?> value)
   {
      RegistryValue entry = registry.get(key);
      if (entry != null)
      {
