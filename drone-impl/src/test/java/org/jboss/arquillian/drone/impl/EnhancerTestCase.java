...
public class EnhancerTestCase extends AbstractTestTestBase {
    ...
    public void testClassLevel() throws Exception {
        ...
        MockDrone droneInstance = context.get(MockDrone.class, Default.class);
